...
export function ServicesPage() {
  ...
  return (
    <div className="w-full">
      ...
      {/* العودة للخدمات */}
      <div className="sticky top-[60px] z-50 px-4 py-2 flex items-center w-full md:w-auto mx-auto rounded-b-lg bg-white/70 backdrop-blur">
        <Link
          to="/"
          className="flex items-center gap-2 text-[#154734] hover:text-[#0f2d1f] font-medium"
        >
  ...
  <img
    ...
    alt="bg-about"
    className="absolute inset-0 w-[500%] h-full object-contain"
  />
      ...
      <section className="py-20 bg-[#f2f9f5] flex justify-center">
        <div className="relative w-full max-w-6xl p-1 md:p-10 border-4 border-[#154734] rounded-t-[200px] flex flex-col md:flex-row items-center gap-10 bg-white shadow-lg">
          <div className="flex-1 flex justify-center">
            <img
              src="https://unitededucation.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmulticultura.cac5734c.png&w=1920&q=75"
              alt="video-sec"
