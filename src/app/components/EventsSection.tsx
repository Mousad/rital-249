...
const events = [
  ...
  },
  {
    ...
    title: "معرض الجامعات التركية 2025",
    ...
    <section className="py-20 px-4 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl font-black text-gray-900 mb-4">  الفعاليات</h2>
          <p className="text-gray-500 max-w-xl mx-auto leading-relaxed">
            نبني مجتمعاً طلابياً متماسكاً من خلال الفعاليات والأنشطة التي تجمع طلابنا من مختلف الدول
          </p>
          <div className="w-70 h-1 rounded-full mx-auto mt-5" style={{ backgroundColor: "#1c398e" }} />
        </div>
          ...
          {events.map((ev, i) => (
            <div
              ...
              className={`p-5 rounded-2xl cursor-pointer transition-all duration-200 border-2 ${
                i === current ? "shadow-lg" : "hover:shadow-md"
              }`}
              style={{
                borderColor: i === current ? "#0d2b5e" : "#e8ecf0",
                backgroundColor: i === current ? "#0d2b5e08" : "white",
              }}
            >
              <div className="flex gap-4 items-center">
                ...
                <div>
                  <p
                    ...
                    style={{ color: i === current ? "#0d2b5e" : "#333" }}
                  >
                    {ev.title}
                  </p>
