...
const programs = [
  {
    ...
    image: "https://images.unsplash.com/photo-1622016579436-14c1844c99ec?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
    duration: "4 سنوات",
    lang: "عربي / إنجليزي",
    tag: "الأكثر طلباً",
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1704748082614-8163a88e56b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
    duration: "4 سنوات",
    lang: "تركي / إنجليزي",
    tag: "",
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1707072787409-c0ad76ce75e7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
    duration: "4 سنوات",
    lang: "إنجليزي",
    tag: "منحة متاحة",
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1690060806285-67f27a66ac94?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
    duration: "سنتان",
    lang: "إنجليزي",
    tag: "الأكثر طلباً",
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1766297246931-7b861269dab0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
    duration: "سنتان",
    lang: "إنجليزي / تركي",
    tag: "منحة متاحة",
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1757143137392-0b1e1a27a7de?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
    duration: "سنتان",
    lang: "إنجليزي",
    tag: "",
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1600096036367-a2bf5895620e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
    duration: "سنة واحدة",
    lang: "تركي / إنجليزي",
    tag: "",
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1762438136374-b2fe754053f0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400",
    duration: "سنة واحدة",
    lang: "إنجليزي",
    tag: "الأكثر طلباً",
  },
